			...
			<div class="col-md-3">
				<form>
					<div class="form-group">
						<label for="searchText">검색 단어</label>
			...
			<c:forEach items="${foodList }" var="food">
				<div id="row">
					<div id="img" class="col-md-3">
						<img alt="" src="${food.img }" width="50%">
					</div>
					<div id="content" class="col-md-9">
						<div id="foodName"><h4><strong>${food.name }</strong></h4></div>
						<div id="foodMaker">${food.maker }</div>
						<p>${food.material }</p>
						<p><a class="btn btn-info" href="detail.do?code=${food.code}" role="submit" onclick="">View details</a></p>
					<hr />
					</div>
				</div>
			</c:forEach>
...
$("#searchBtn").on("click", function() {
 	location.href="search.do?condition="+$("#condition").val()+"&searchText="+$("#searchText").val();
});
</script>
</html>