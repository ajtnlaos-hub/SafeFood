...
<body>
	...
	<div class="container">
		<table class="table">
			...
			<tr><td class="col-md-12" colspan="4">${notice.contents }</tr>
		</table>
		<br>
...
$("#modifyNoticeBtn").on("click", function() {
	location.href="getModifyNoticeForm.do?noticeNum="+${notice.noticeNum};
});
$("#deleteBtn").on("click", function() {
	location.href="deleteNotice.do?noticeNum="+${notice.noticeNum};
});
</script>
<style>
.jumbotron {
